...
Skills live in `.agents/skills/`, `.claude/skills/` and `.grok/skills/`. They
are third-party and installed with `gh skill add`: read them, do not reformat
them. Consult the relevant one before touching hooks or admin UI

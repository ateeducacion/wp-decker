...
under `.agents/skills/` (Copilot, Codex, Cursor, Grok Build) and
`.claude/skills/` (Claude Code). Grok Build scans `.agents/skills/` natively.
Install and refresh them with the GitHub CLI:

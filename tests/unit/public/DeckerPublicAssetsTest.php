...
class DeckerPublicAssetsTest extends Decker_Test_Base {
	...
	public function test_decker_vars_payload_shape() {
		...
		// Pin the full key set, so a rename is caught as well as an add or a drop.
		$this->assertSame(
			array(
				...
				'ok',
				'cancel',
				'confirm_archive_task_title',
				'confirm_archive_task_text',
				'confirm_unarchive_task_title',
				'confirm_unarchive_task_text',
				'archive_task',
				'unarchive_task',
				'failed_archive_task',
				'task_archived_success',
				'task_unarchived_success',
				'error_archiving_task',
				'confirm_clone_task_title',
				'confirm_clone_task_text',
				'clone_task',
				'task_cloned_success',
				'error_cloning_task',
				'merge_task',
				'merge_task_title',
				'merge_task_text',
				'merge_task_search_placeholder',
				'merge_task_search_hint',
				'merge_task_searching',
				'merge_task_no_results',
				'merge_task_select_label',
				'select_task_to_merge',
				'confirm_merge_task_title',
				'confirm_merge_task_text',
				'confirm_merge_task_button',
				'task_merged_success',
				'error_merging_task',
				'success',
				'error',

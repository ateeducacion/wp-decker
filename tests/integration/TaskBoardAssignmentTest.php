...
class TaskBoardAssignmentTest extends Decker_Test_Base {
	...
	public function testExplicitlyChangingBoardShouldWork() {
		...
		$taskA_to_move = self::factory()->task->create(
			array(
				'post_title' => 'Task A To Move',
		...
		$taskD         = self::factory()->task->create(
			array(
				'post_title' => 'Task D B2',
				'board'      => $this->board2_id,
				'stack'      => 'to-do',
			)
		);
		$taskE         = self::factory()->task->create(
			array(
				'post_title' => 'Task E B2',
				'board'      => $this->board2_id,
				'stack'      => 'to-do',
			)
		);
	...
	public function testMovingTasksAcrossThreeBoardsMaintainsOrder() {
		...
		$taskA1 = self::factory()->task->create(
			array(
				'post_title' => 'A1',
				'board'      => $this->board1_id,
				'stack'      => 'to-do',
		...
		$taskA2 = self::factory()->task->create(
			array(
				'post_title' => 'A2',
				'board'      => $this->board1_id,
				'stack'      => 'to-do',
		...
		$taskB1 = self::factory()->task->create(
			array(
				'post_title' => 'B1',
				'board'      => $this->board2_id,
				'stack'      => 'to-do',
		...
		$taskB2 = self::factory()->task->create(
			array(
				'post_title' => 'B2',
				'board'      => $this->board2_id,
				'stack'      => 'to-do',
		...
		$taskC1 = self::factory()->task->create(
			array(
				'post_title' => 'C1',
				'board'      => $this->board3_id,
				'stack'      => 'to-do',
			)
		);
		$taskC2 = self::factory()->task->create(
			array(
				'post_title' => 'C2',
				'board'      => $this->board3_id,
				'stack'      => 'to-do',

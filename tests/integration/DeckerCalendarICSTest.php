...
public function set_up() {
	...
	public function test_multiple_events_ics_download() {
		self::factory()->event->create( [ 'post_title' => 'Event 1', 'meta_input' => [ 'event_start' => '2025-01-01 09:00:00', 'event_end' => '2025-01-01 10:00:00' ] ] );
		self::factory()->event->create( [ 'post_title' => 'Event 2', 'meta_input' => [ 'event_start' => '2025-01-02 14:00:00', 'event_end' => '2025-01-02 16:00:00' ] ] );
		...
		$this->assertEqualsCanonicalizing( [ 'Event 1', 'Event 2' ], $titles );
	}

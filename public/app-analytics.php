...
<head>
	<title><?php esc_htmlesc_html_e( 'Analytics Dashboard', 'decker' ); ?> | Decker</title>
							...
							<div class="page-title-box">
								<div class="page-title-right">
									<ol class="breadcrumb m-0">
										...
										<li class="breadcrumb-item active"><?php esc_htmlesc_html_e( 'Analytics', 'decker' ); ?></li>
									</ol>
								</div>
								<h4 class="page-title"><?php esc_htmlesc_html_e( 'Analytics', 'decker' ); ?></h4>
							</div>
						</div>
					</div>     
...
<?php include 'layouts/top-alert.php'; ?>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title"><?php esc_htmlesc_html_e( 'Active Tasks', 'decker' ); ?></h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title"><?php esc_htmlesc_html_e( 'Total Users', 'decker' ); ?></h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title"><?php esc_htmlesc_html_e( 'Archived Tasks', 'decker' ); ?></h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="card">
								<div class="card-body">
									<h4 class="card-title"><?php esc_htmlesc_html_e( 'Total Boards', 'decker' ); ?></h4>
...
<div id="chartsContainer" class="container">
	...
	<div class="row">
		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title"><?php esc_htmlesc_html_e( 'Tasks by Board', 'decker' ); ?></h5>
		...
		<div class="col-md-6">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title"><?php esc_htmlesc_html_e( 'Tasks by User', 'decker' ); ?></h5>
	...
	<div class="row">
		...
		<div class="col-md-6 mx-auto">
			<div class="card">
				<div class="card-body">
					<h5 class="card-title"><?php esc_htmlesc_html_e( 'Tasks by Stack', 'decker' ); ?></h5>

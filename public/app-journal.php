...
$sample_days   = array();
$sample_boards = array(
    array( 'name' => 'Soporte', 'color' => '#0d6efd' ),
    array( 'name' => 'Desarrollo', 'color' => '#198754' ),
    array( 'name' => 'Planificación', 'color' => '#6f42c1' ),
);
                                ...
                                <form class="row gy-2 gx-2 align-items-center me-2" id="daily-view-form">
                                    ...
                                    <div class="col-auto">
                                        <button type="button" class="btn btn-outline-secondary" id="preview-btn" data-bs-toggle="modal" data-bs-target="#journalPreviewModal">
                                            <i class="ri-eye-line me-1"></i><?php echo esc_html__( 'Previsualizar', 'decker' ); ?>
                                        </button>
                                    </div>
                                </form>
                                <div class="col-auto">
                ...
                <div id="mock-view-content" class="row">
                                        ...
                                        <div class="card-body pt-2">
                                            ...
                                            <table class="table table-sm table-borderless table-hover table-nowrap table-centered m-0 journal-tasks-table">
                                                <thead class="border-top border-bottom bg-light-subtle border-light">
                                                    <tr>
                                                        <th class="py-1"><?php echo esc_html__( 'Tablero', 'decker' ); ?></th>
                                                        <th class="py-1"><?php echo esc_html__( 'Título', 'decker' ); ?></th>
                                            ...
                                            <div class="mt-3">
                                            <h6 class="card-title mb-2"><?php echo esc_html__( 'Notas del día', 'decker' ); ?></h6>
                                            <?php
                                            ...
                                            <div class="d-flex justify-content-between align-items-center mt-2">
                                                <div class="text-muted small">
                                                    <?php echo esc_html__( 'Último guardado:', 'decker' ); ?>
                                                    <span class="mock-notes-last-saved" data-date="<?php echo esc_attr( $date_key ); ?>">—</span>
                                                </div>
                                                <button class="btn btn-primary mock-save-notes-btn" data-date="<?php echo esc_attr( $date_key ); ?>"><i class="ri-save-3-line me-1"></i><?php echo esc_html__( 'Guardar', 'decker' ); ?></button>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="alert alert-info">
                            <?php echo esc_html__( 'Vista de ejemplo sin tablero seleccionado. Use esta maqueta para revisar el diseño.', 'decker' ); ?>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="journalPreviewModalLabel"><?php echo esc_html__( 'Previsualización de Diario', 'decker' ); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php esc_attr_e( 'Close', 'decker' ); ?>"></button>
                </div>
                <div class="modal-body">
                    <div class="row g-2 align-items-end mb-3">
                        <div class="col-sm-6">
                            <label for="preview-from" class="form-label"><?php echo esc_html__( 'Desde', 'decker' ); ?></label>
                            <input type="date" id="preview-from" class="form-control">
                        </div>
                        <div class="col-sm-6">
                            <label for="preview-to" class="form-label"><?php echo esc_html__( 'Hasta', 'decker' ); ?></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="journal-preview-print"><i class="ri-printer-line me-1"></i><?php echo esc_html__( 'Imprimir', 'decker' ); ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        jQuery(document).ready(function($) {
            ...
            if (previewModalEl) {
                ...
                const renderPreview = () => {
                    ...
                    if (!mockContainer.length) {
                        container.innerHTML = '<div class="alert alert-info"><?php echo esc_html__( 'No hay contenido para previsualizar en esta vista.', 'decker' ); ?></div>';
                        return;
                    }

                    const cards = mockContainer.find('.journal-day-card');
                    if (!cards.length) {
                        container.innerHTML = '<div class="alert alert-info"><?php echo esc_html__( 'No hay días disponibles.', 'decker' ); ?></div>';
                        return;
                    }
                    ...
                    if (!container.children.length) {
                        container.innerHTML = '<div class="alert alert-warning"><?php echo esc_html__( 'No hay resultados en el rango seleccionado.', 'decker' ); ?></div>';
                    }
                };
                ...
                document.getElementById('journal-preview-print')?.addEventListener('click', function(){
                    ...
                    if (!w) return;
                    const html = `<!doctype html><html><head><meta charset="utf-8"><title><?php echo esc_html__( 'Previsualización de Diario', 'decker' ); ?></title>
                    <style>
